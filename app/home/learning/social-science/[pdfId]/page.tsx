...
I'm your Social Science learning assistant. I'll help you understand the content in this document. You can ask me:
...
What would you like to know about this document?`,
  ...
  const handleExitFileMode = () => {
    router.push("/home/learning/social-science")
  }
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* PDF Info Banner */}
      <div className="bg-red-100/20 border-b p-3 flex items-center justify-between">
            ...
            {messages.map((message) => (
              ...
              >
                <div className={`flex gap-3 max-w-[80%] ${message.type === "user" ? "flex-row-reverse" : "flex-row"}`}>
                  <Avatar className={message.type === "ai" ? "bg-red-100/20" : "bg-red-600/20"}>
                  ...
                  <Card className={`p-4 ${message.type === "user" ? "bg-red-600 text-white" : "bg-white border"}`}>
                    {message.type === "user" ? (
