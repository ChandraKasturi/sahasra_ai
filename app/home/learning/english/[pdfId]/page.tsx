...
I'm your English learning assistant. I'll help you understand the content in this document. You can ask me:
...
What would you like to know about this document?`,
  ...
  const handleExitFileMode = () => {
    router.push("/home/learning/english")
  }
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* PDF Info Banner */}
      <div className="bg-brand-navy/5 border-b p-3 flex items-center justify-between">
